...
namespace ARM_CONST
{
    ...
    const double EXTEND_MAX = 400;
    const double TILT_MAX = 400;
    const double CLAW_MAX = 400;

    const double EXTEND_MIN = -400;
    const double TILT_MIN = 400;
    const double CLAW_MIN = -400;
}
