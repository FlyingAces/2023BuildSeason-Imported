...
class RedLongAutoNoScore : public frc2::CommandHelper<frc2::SequentialCommandGroup, RedLongAutoNoScore> {
    public:
    RedLongAutoNoScore(DriveTrainSubsystem* p_DriveTrain, GyroSubsystem* p_Gyro);
