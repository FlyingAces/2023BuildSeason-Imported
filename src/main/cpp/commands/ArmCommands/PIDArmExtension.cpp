...
PIDArmExtension::PIDArmExtension(ArmSubsystem* arm, double extensionRotations) 
    : CommandHelper{frc2::PIDController{ARM_PID_CONST::EXTEND_P, ARM_PID_CONST::EXTEND_I, ARM_PID_CONST::EXTEND_D},
